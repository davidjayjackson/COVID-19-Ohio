...
```{r}
ggplot(buckeye) + geom_line(aes(x=date,y=median_deaths,col="Median Deaths")) + 
  labs(title = "Ohio Daily Median Deaths",y="Median Deaths") +
  scale_y_continuous(labels = comma) + ylim(0,250) +
  geom_line(data=us_no_ohio,aes(x=date,y=median_deaths,col="US Median Cases"))
```
