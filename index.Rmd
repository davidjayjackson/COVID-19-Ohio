...
US$MAC <- movavg(US$new_cases,28,type="e")
US$MAD <- movavg(US$new_deaths,28,type="e")

ggplot(US,aes(x=date,y=MAC)) + geom_area() +
    labs(title="Ohio Daily COVID19 Cases by Date",
         subtitle = "(28 Day Moving Average)") 
  

ggplot(US,aes(x=date,y=MAD)) + geom_area() +
