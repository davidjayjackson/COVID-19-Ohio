...
plot(US$date,US$new_cases,type="l",main="Ohio's COVID-19 Cases Apr. 1,2020 - Aug. 31, 2020 \n ( Red line = 14 day moving avearge)",xlab="Date",ylab="Cases",col="blue") 
...
plot(US$date,US$new_deaths,type="l",main="Ohio's COVID-19 Deaths Apr. 1,2020 - Aug. 31, 2020 \n (Red = 14 day moving average)",xlab="Date",ylab="Deaths",col="blue")
...
### Top Five Counties Based on Daily Totals for Aug. 28

```{r}
# df <- subset(DF,date =="2020-08-27" )
# df$new_cases <- sort(df$new_cases)
# df_cases <-head(df,n=5)
# barplot(new_cases ~county,data=df_cases,main="Top 5 Counties Ranked by single Day Cases",xlab="(For August 28, 2020)",ylab="Cases")
# grid(col="black")
# df$new_deaths <- sort(df$new_deaths,decreasing=TRUE)
# df_deaths <-head(df,n=5)
# barplot(new_deaths ~county,data=df_deaths,main="Top 5 Counties Ranked by single Day Deaths",xlab="(For August 28, 2020)",ylab="Cases")
# grid(col="black")
```
