...
Top5 <-head(Top,n=5)
barplot(new_cases ~county,data=Top5,main="Top 5 Counties Ranked by single Day Cases",xlab="(For Sept 3, 2020)",ylab="Cases")
grid(col="black")

Topd <- df[order(df$new_deaths,decreasing = TRUE),]
Top5d <-head(Topd,n=5)
barplot(new_deaths ~county,data=Top5d,main="Top 5 Counties Ranked by single Day Deaths",xlab="(For Sept 3, 2020)",ylab="Cases")
grid(col="black")
```
