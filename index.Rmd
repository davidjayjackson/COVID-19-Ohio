...
plot(US$date,US$new_cases,type="l",main="Ohio's COVID-19 Cases Apr. 1,2020 - Aug. 18, 2020 \n ( Red line = 14 day moving avearge)",xlab="Date",ylab="Cases",col="blue") 
...
```
```{r}
US <- subset(df,date >="2020-04-01" & date <="2020-08-17")
US$new_deaths14 <- movingAverage(US$new_deaths,14)
plot(US$date,US$new_deaths,type="l",main="Ohio's COVID-19 Deaths Apr. 1,2020 - Aug. 17, 2020 \n (Red = 14 day moving average)",xlab="Date",ylab="Deaths",col="blue")
