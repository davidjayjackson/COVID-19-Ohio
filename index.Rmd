...
```{r,echo=FALSE}
plot1 <-ggplot(oh_counties) + geom_col(aes(x=date,y=cases,fill=county)) +
...
plot2 <- ggplot(oh_counties) + geom_col(aes(x=date,y=deaths,fill=county)) +
