...
db <- db <- dbConnect(RSQLite::SQLite(),dbname= "../COVIDDB/NYTimes.sqlite3")
...
```
```{r}
### Fix Numbers for Nov. 26 - 27 
# df$new_cases <-ifelse(df$date =="2020-11-26",mean(df$new_cases),df$new_cases)
# df$new_deaths <-ifelse(df$date =="2020-11-26",mean(df$new_deaths),df$new_deaths)
# df$new_cases <-ifelse(df$date =="2020-11-27",mean(df$new_cases),df$new_cases)
# df$new_deaths <-ifelse(df$date =="2020-11-27",mean(df$new_deaths),df$new_deaths)
```
